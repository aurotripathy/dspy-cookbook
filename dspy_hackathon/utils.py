"""Shared helpers for the dspy_hackathon notebooks / scripts.

Currently provides Gemini model resolution: given a preference list of LiteLLM-
style Gemini model ids (e.g. "gemini/gemini-2.5-pro"), probe each one with a
trivial call and return the first that actually responds to the current
