...
# #Databricks and DSPy
#
# In the last section, you saw how DSPy has some cutting-edge techniques to help you go to production. 
# Once you have you AI Agents in good shape after developing modular components and optimizing the prompts, 
# you can use Databricks to deploy your agents and use them in production. 
#
# In this notebook, we will cover some other capabilities that you can use DSPy with so that you have it as reference. 
# These capabilities are not necessary for production but important to keep in mind when you eventually need it

# COMMAND ----------

# #Databricks AI Bridge and DSPy 
#
# This is an ongoing effort at Databricks to create a library that better integrates with Databricks products, 
# particularly with authentication. AI Bridge helps pass your workspace client credentials throughout DSPy! 
#
...
# %pip install --upgrade dspy mlflow databricks-agents databricks-sdk databricks-mcp databricks-dspy uv
